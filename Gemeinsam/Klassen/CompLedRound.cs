...
namespace Helper
{
    ...
    public class CompLedRound : PictureBox
    {
        ...
        [Category("Default"), Description("")]
        private CompLedRectangle.CompLedState m_State;
        public CompLedRectangle.CompLedState State
        {
        ...
        public CompLedRound()
        {
            this.Width = 25;
            this.Height = 25;
            this.State = CompLedRectangle.CompLedState.LedOff;
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (this.m_State == CompLedRectangle.CompLedState.LedOff)
            {
            ...
            if (this.m_State == CompLedRectangle.CompLedState.LedOn)
            {
                this.OnValueChanged(EventArgs.Empty);
                if (this.Type == LEDType.Normal)
                {

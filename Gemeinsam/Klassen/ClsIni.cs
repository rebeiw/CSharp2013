...
public class ClsIni
{
	...
	public Boolean commentValue(String Caption, String Entry, Boolean CaseSensitive=true)
	{
	...
	public Boolean deleteValue(String Caption, String Entry, Boolean CaseSensitive=true)
	{
		int line = SearchEntryLine(Caption, Entry, CaseSensitive);
		if (line < 0) return false;
		lines.RemoveAt(line);
	...
	public String getValue(String Caption, String Entry, Boolean CaseSensitive=true)
	{
		int line = SearchEntryLine(Caption, Entry, CaseSensitive);
		if (line < 0) return "";
	...
	public Boolean setValue(String Caption, String Entry, String Value, Boolean CaseSensitive=true)
	{
		Caption = Caption.ToLower();
		if (!CaseSensitive) Entry = Entry.ToLower();
